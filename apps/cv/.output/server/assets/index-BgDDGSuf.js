...
import { c as cn, P as Primitive, u as useLayoutEffect2, a as createContextScope, b as useComposedRefs, d as useCallbackRef, e as composeEventHandlers, f as dispatchDiscreteCustomEvent, g as useControllableState } from "./router-D-uHloC7.js";
  ...
  return /* @__PURE__ */ jsx("div", { className: "mt-1 inline-flex w-full flex-wrap gap-x-3 gap-y-1 text-[13px] leading-6", children: contacts.map((contact) => {
    ...
    if (contact.hoverContent) {
      return /* @__PURE__ */ jsxs(HoverCard, { openDelay: 100, closeDelay: 100, children: [
        /* @__PURE__ */ jsx(HoverCardTrigger, { asChild: true, children: /* @__PURE__ */ jsx(ResumeLink, { href: contact.url, external: true, className: "text-inherit", children: contact.label }) }),
    ...
    return /* @__PURE__ */ jsx(ResumeLink, { href: contact.url, external: true, className: "text-inherit", children: contact.label }, contact.id);
  }) });
}
...
function Section({ title, className, children }) {
  return /* @__PURE__ */ jsxs("section", { className: cn(className), children: [
    /* @__PURE__ */ jsx(
      "h2",
      {
        className: "mb-3 font-[family-name:var(--font-serif)] text-lg font-bold tracking-tight text-neutral-500 dark:text-neutral-400",
        children: title
      }
    ),
    children
...
function Skill({
  ...
  return /* @__PURE__ */ jsxs(
    HoverCard,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(HoverCardTrigger, { asChild: true, children: url ? /* @__PURE__ */ jsx(
          ResumeLink,
          {
            href: url,
            external: true,
