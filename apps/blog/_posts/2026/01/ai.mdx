...
It can consolidates all your subscriptions: ~Claude Code~, Z.AI, 
[GitHub Copilot](https://x.com/github/status/2011822451613712646), Codex, ...  seamlessly switch between all of the models + plus some free Zen models from their own provider.
