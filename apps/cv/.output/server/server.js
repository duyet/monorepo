...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CIYY5TKK.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-D-uHloC7.js").then((n2) => n2.r);
  return {
