...
[AGENTS.md](https://agents.md) the similar mission. If you use both Claude Code and other coding agents (like Codex, Cursor), create a symlink so they share the same instructions:

```bash
ln -s CLAUDE.md AGENTS.md
```

or put instructions in `AGENTS.md` an open standard and `CLAUDE.md`:
