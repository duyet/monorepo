...
export function getOrgColor(org: string): string {
  const colors = [
    "bg-[color-mix(in_srgb,var(--rd-accent)_12%,var(--rd-surface))] text-[var(--rd-accent)]",
    "bg-[var(--rd-surface-2)] text-[var(--rd-text-2)]",
    "bg-[color-mix(in_srgb,var(--rd-ok)_12%,var(--rd-surface))] text-[var(--rd-ok)]",
    "bg-[color-mix(in_srgb,var(--rd-down)_12%,var(--rd-surface))] text-[var(--rd-down)]",
    "bg-[color-mix(in_srgb,var(--rd-warn)_12%,var(--rd-surface))] text-[var(--rd-warn)]",
    "bg-[var(--rd-surface-2)] text-[var(--rd-text-3)]",
