...
export function NoteCard({
  ...
  return (
    <Link
      to="/note/$id/"
      params={{ id: note.id }}
      className={`group/bento relative flex flex-col overflow-hidden bg-white dark:bg-gray-900 ${paddingClass} no-underline transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 ${
