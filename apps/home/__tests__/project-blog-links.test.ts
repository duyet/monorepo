...
// Blog data comes from __tests__/fixtures/posts-data.json via the
// vitest.config.ts alias — the real posts-data.json is generated by the blog
// build and doesn't exist on CI.
