...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DrwEV7w6.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-Br8aIiDN.js").then((n2) => n2.r);
  return {
