import React__default, { useMemo, useCallback, useSyncExternalStore, useRef, useState, useEffect, createContext, useContext, createElement } from "react";
...
function SWRConfigCompat({ swrConfig, children }) {
  return /* @__PURE__ */ React__default.createElement(SWRConfig, { value: swrConfig }, children);
}
...
const OrganizationProvider = ({ children, organization, swrConfig }) => {
  return /* @__PURE__ */ React__default.createElement(SWRConfigCompat, { swrConfig }, /* @__PURE__ */ React__default.createElement(OrganizationContextInternal.Provider, { value: { value: { organization } } }, children));
};
...
const useSafeLayoutEffect = typeof window !== "undefined" ? React__default.useLayoutEffect : React__default.useEffect;
...
const Elements = (({ stripe: rawStripeProp, options, children }) => {
  const parsed = React__default.useMemo(() => parseStripeProp(rawStripeProp), [rawStripeProp]);
  const [ctx, setContext] = React__default.useState(() => ({
  ...
  return /* @__PURE__ */ React__default.createElement(ElementsContext.Provider, { value: ctx }, children);
});
const useElementsContextWithUseCase = (useCaseMessage) => {
  return parseElementsContext(React__default.useContext(ElementsContext), useCaseMessage);
};
const useElements = () => {
...
const ValidateStripeUtils = ({ children }) => {
  ...
  return /* @__PURE__ */ React__default.createElement(StripeUtilsContext.Provider, { value: { value: {
    stripe,
    elements
  } } }, children);
};
const DummyStripeUtils = ({ children }) => {
  return /* @__PURE__ */ React__default.createElement(StripeUtilsContext.Provider, { value: { value: {} } }, children);
};
const PropsProvider = ({ children, ...props }) => {
  const utils = usePaymentSourceUtils(props.for);
  const [isPaymentElementReady, setIsPaymentElementReady] = useState(false);
  return /* @__PURE__ */ React__default.createElement(PaymentElementContext.Provider, { value: { value: {
    ...props,
    ...utils,
...
const PaymentElementProvider = ({ children, ...props }) => {
  return /* @__PURE__ */ React__default.createElement(PropsProvider, props, /* @__PURE__ */ React__default.createElement(PaymentElementInternalRoot, null, children));
};
const PaymentElementInternalRoot = (props) => {
  const { stripe, externalClientSecret, stripeAppearance } = usePaymentElementContext();
  const locale = useLocalization();
  if (stripe && externalClientSecret) return /* @__PURE__ */ React__default.createElement(Elements, {
  ...
  }, /* @__PURE__ */ React__default.createElement(ValidateStripeUtils, null, props.children));
  return /* @__PURE__ */ React__default.createElement(DummyStripeUtils, null, props.children);
};
const PaymentElement = ({ fallback }) => {
  ...
  if (!stripe || !externalClientSecret) return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, fallback);
  return /* @__PURE__ */ React__default.createElement(PaymentElement$1, {
    fallback,
    onReady,
    options
  });
...
function useEmailLink(resource) {
  const { startEmailLinkFlow, cancelEmailLinkFlow } = React__default.useMemo(() => resource.createEmailLinkFlow(), [resource]);
  React__default.useEffect(() => {
...
var CustomPortalsRenderer = (props) => {
  var _a, _b;
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, (_a = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a.map((portal, index) => createElement(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => createElement(portal, { key: index })));
};
...
function ClerkContextProvider(props) {
  ...
  const clerkCtx = React__default.useMemo(
    () => ({ value: clerk }),
    [
  ...
  const clientCtx = React__default.useMemo(() => ({ value: state.client }), [state.client]);
  const {
    sessionId,
    sessionStatus,
    sessionClaims,
  ...
  const authCtx = React__default.useMemo(() => {
    const value = {
      sessionId,
      sessionStatus,
      sessionClaims,
  ...
  const sessionCtx = React__default.useMemo(() => ({ value: session }), [sessionId, session]);
  const userCtx = React__default.useMemo(() => ({ value: user }), [userId, user]);
  const organizationCtx = React__default.useMemo(() => {
    const value = {
      organization
    };
    return { value };
  ...
  return (
    ...
    /* @__PURE__ */ React__default.createElement(IsomorphicClerkContext.Provider, { value: clerkCtx }, /* @__PURE__ */ React__default.createElement(ClientContext.Provider, { value: clientCtx }, /* @__PURE__ */ React__default.createElement(SessionContext.Provider, { value: sessionCtx }, /* @__PURE__ */ React__default.createElement(OrganizationProvider, { ...organizationCtx.value }, /* @__PURE__ */ React__default.createElement(AuthContext.Provider, { value: authCtx }, /* @__PURE__ */ React__default.createElement(UserContext.Provider, { value: userCtx }, /* @__PURE__ */ React__default.createElement(
...
var useLoadedIsomorphicClerk = (options) => {
  const isomorphicClerkRef = React__default.useRef(IsomorphicClerk.getOrCreateInstance(options));
