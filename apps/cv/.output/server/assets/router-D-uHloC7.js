...
function AnalyticWrapper() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    GA_MEASUREMENT_ID && /* @__PURE__ */ jsx(
      Script,
      {
    ...
    GA_MEASUREMENT_ID && /* @__PURE__ */ jsx(Script, { id: "google-analytics", strategy: "afterInteractive", children: `
            window.dataLayer = window.dataLayer || [];
            function gtag(){window.dataLayer.push(arguments);}
            gtag('js', new Date());
            gtag('config', '${GA_MEASUREMENT_ID}');
          ` }),
    /* @__PURE__ */ jsx(Script, { id: "pageview", strategy: "beforeInteractive", children: `
        ...
        ` }),
    /* @__PURE__ */ jsx(Script, { id: "clarity", strategy: "afterInteractive", children: `
      ...
      ` }),
    POSTHOG_API_KEY && /* @__PURE__ */ jsx(Script, { id: "posthog", strategy: "afterInteractive", children: `
...
function HeaderBranding({
  ...
  const textContent = shortText && longText ? /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("span", { className: cn("hidden sm:block", center && "md:text-7xl md:mt-5"), children: longText })
...
const $$splitComponentImporter = () => import("./index-BgDDGSuf.js");
