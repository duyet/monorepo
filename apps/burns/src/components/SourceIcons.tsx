...
const icons: Record<string, string> = {
  ...
  "Z.AI": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
  ...
  opencode: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd">
    <title>opencode</title>
    <path d="M16 6H8v12h8V6zm4 16H4V2h16v20z" />
  </svg>`,
  "Claude Code": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
