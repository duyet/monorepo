...
export const twHeader = {
  ...
  cta: "inline-flex h-9 max-sm:hidden items-center justify-center rounded-full bg-(--rd-text) px-[1.05rem] text-[0.8125rem] font-medium tracking-[-0.01em] text-(--rd-bg) no-underline hover:opacity-90",
} as const;
