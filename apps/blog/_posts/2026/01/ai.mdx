...
[duyet.net](https://duyet.net) gets updated automatically by Claude Code overnight with a custom tool claude wrapper - my experiment to see how far Claude Code can go, sometime it research for new design, sometime it is broken the website, but it is fun too see. The script looks something like this:
