...
changelog:
  - date: "2026-06"
    note: "Split into a chaptered overview — each topic is now its own page. Refreshed Top on my list (Opus 4.8, GLM 5.1). Added Open Design alternative, opencode and the OpenClaw note on long-running autonomous agents."
  - date: "2026-03"
