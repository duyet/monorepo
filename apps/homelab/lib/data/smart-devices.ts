...
export const smartDevices: SmartDevice[] = [
  ...
  },
  {
    ...
    model: "DQS-H1",
    detail: "18 devices connected",
  },
  // 12 smart lights
  ...Array.from({ length: 12 }, (_, i) => ({
    id: `light-${i + 1}`,
    name: `Smart Light ${i + 1}`,
    brand: "dqsmart",
    type: "light" as const,
    status: (i < 8 ? "online" : "idle") as "online" | "idle",
    icon: "lightbulb",
    location: [
      "Living room", "Living room", "Kitchen", "Kitchen",
      "Bedroom", "Bedroom", "Bathroom", "Hallway",
      "Study", "Study", "Balcony", "Garage",
    ][i],
    detail: i < 8 ? "On" : "Off",
  })),
  {
