        ...
        <table className="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            {sortedTools.map((tool, toolIndex) => (
              <tr
                key={toolIndex}
                className={toolIndex % 2 === 0 ? "bg-white" : "bg-gray-50"}
              >
                ...
                {features.map((feature, featureIndex) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`inline-flex items-center space-x-2 px-3 py-1 rounded-full text-xs font-medium ${getScoreColor(score)}`}
                      >
                        {getScoreIcon(score)}
