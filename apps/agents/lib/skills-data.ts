...
export const AGENT_SKILLS = [
  {
    "metadata": {
      "name": "duyet-info",
      "description": "Fetch and comprehend comprehensive information about Duyet using llms.txt endpoints. Use this skill when the user asks questions regarding Duyet's background, CV, projects, blogs, site structure, or general profile, or anytime you need broad access to data across the duyet.net ecosystem.\n",
      "license": "MIT",
      "metadata": {
        "author": "duyet",
        "version": "1.0"
