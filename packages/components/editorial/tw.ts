/** Shared Tailwind class strings for home + blog. */
export const tw = {
  ...
  labelPlum: "bg-[var(--rd-label-plum)] text-[var(--rd-label-plum-fg)]",
  labelPine: "bg-[var(--rd-label-pine)] text-[var(--rd-label-pine-fg)]",
  labelSlate: "bg-[var(--rd-label-slate)] text-[var(--rd-label-slate-fg)]",
  ...
  pageHead: "pt-12 mb-12 border-b border-[var(--rd-line)] pb-8",
  pageTitle:
    "m-0 font-[family-name:var(--font-display)] text-[clamp(2.1rem,4.5vw,3.4rem)] font-normal tracking-[-0.03em] leading-[1.08] text-[var(--rd-text)] text-balance",
  mono: "font-[family-name:var(--font-mono)] text-[0.8125rem] text-[var(--rd-text-3)]",
} as const;
