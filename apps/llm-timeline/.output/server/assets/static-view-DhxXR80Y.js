...
import { d as cn, m as models, g as getSlug, o as organizations } from "./router-CuHdCRg8.js";
import { d as getTypeColor, g as getLicenseColor, e as getSourceColor, h as getRelatedModels, M as MODEL_CARD_RELATED_MODELS_LIMIT, c as filterModels, i as groupByYear, j as groupByOrg, D as DEFAULT_FILTERS, p as parseParamValue, f as formatDate, a as getLicenseBarColor } from "./utils-B-o2Gk5e.js";
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 px-2 opacity-40 bg-[length:4px_4px] bg-repeat-x bg-center [background-image:radial-gradient(circle,rgb(212_212_212)_1px,transparent_1px)] dark:[background-image:radial-gradient(circle,rgb(64_64_64)_1px,transparent_1px)]" }),
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "mb-6 flex items-center gap-4 overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium truncate max-w-[12rem] text-neutral-900 dark:text-neutral-100", children: org }),
