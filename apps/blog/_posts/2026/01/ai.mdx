...
2026-03: [Agent Teams](https://code.claude.com/docs/en/agent-teams) just dropped - this is basically what I was trying to build with my [team-agents plugin](#parallel-agents). Multiple Claude Code sessions that actually talk to each other, not just report back to a parent. Now it's built-in. Enable with `CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS`.
...
Tasks are session-scoped: they live in the current Claude Code process and are gone when you exit. For durable scheduling that survives restarts, use [GitHub Actions](#claude-code-openrouter-on-github-actions) or Desktop scheduled tasks.
...
<ClaudeCardGrid
  cards={[
    ...
    {
      title: "OpenClaw",
      description: "Personal AI agent — any OS, any platform. The lobster way 🦞",
      link: "https://openclaw.ai"
    },
    {
      title: "NanoBot",
      description: "Ultra-lightweight OpenClaw alternative in Python, ~4k LOC",
      link: "https://github.com/HKUDS/nanobot"
    },
    {
      title: "PicoClaw",
      description: "Go single binary, <10 MB RAM, runs on a $10 board",
      link: "https://picoclaw.net"
    },
    {
      title: "ZeroClaw",
      description: "Rust-based, 3.4 MB, 22+ providers. Zero overhead, zero compromise",
      link: "https://zeroclaw.org"
    },
    {
      title: "NullClaw",
      description: "Zig static binary, 678 KB, ~1 MB RAM, fits on any $5 board",
      link: "https://nullclaw.org"
    }
  ]}
/>
