...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BTm24Qfx.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BL7fPxbg.js").then((n2) => n2.u);
  return {
